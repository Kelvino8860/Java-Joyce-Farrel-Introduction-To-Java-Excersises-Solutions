   ...
   public static void main(String[] args)
      {
         ...
         Path inStateFile = 
             Paths.get("C:\\Users\\NJORO\\Desktop\\Java\\Chapter.13\\InStateCusts.txt");
         Path outOfStateFile = 
             Paths.get("C:\\Users\\NJORO\\Desktop\\Java\\Chapter.13\\OutOfStateCusts.txt");
      ...
      //Dummy file record
       ...
       //Method calls to create empty files
            ...
            while(!(idString.equals(QUIT)))
               {
                 ...
                 System.out.print("Enter name of custoner >> ");
                 name = input.nextLine();

               //Ensure that the names are in uniform length
                ...
                //Use the DecimalFormat class to ensure the balance meets the format requirements 
                //of the file
