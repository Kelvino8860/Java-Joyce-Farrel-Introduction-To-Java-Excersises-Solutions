...
public class DemoHSBaseballGame
{
   public static void main(String[] args)
     {
         HighschoolBaseballGame objOne = new HighschoolBaseballGame();
         ...
         System.out.println("Enter " + objOne.getTeamOne() + " inning scores(There are 7 innings)");
           do{
         ...
         System.out.println("Enter " + objOne.getTeamTwo() + " inning scores(There are 7 innings)");
            do{
                 System.out.print("Enter inning number: ");
                 inning = inputInt.nextInt();
                 System.out.print("Enter score(or 999 to quit): ");
